...
var mate = (function(){
    ...
    var _private = {
        ...
        displayPlaylistInfo:function(data){
            ...
            if(videos_available.length > 0){
                for(var a in videos_available){
                    ...
                    playlistHTML+='' +
                        '<div class="col-xs-2 col-sm-3 col-md-2 col-lg-2 ytbPlaylist" youtube="'+videos_available[a].video_id+'">'+
                        '<label>'+
                        ...
                        '</label>'+
                        '</div>';
                    console.log(videos_available[a]);
                }
        ...
        events:function(){
            ...
            $('.playlistBox').on('click','.ytbPlaylist input',function(){
